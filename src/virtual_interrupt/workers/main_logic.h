...
//==============================================declarations=====================================
VI_RESULT_TYPE(VIError) vi_main_logic_init(
...
VI_RESULT_TYPE(VIError) vi_main_logic_suspend(VIMainLogicStatus* const restrict status);
VI_RESULT_TYPE(VIError) vi_main_logic_resume(VIMainLogicStatus* const restrict status);
